...
#include <math.h>
#include "UtilitiesDJD/VectorsAndMatrices/NumericMatrix.cpp" // Template
...
//	printTensorInExcel(t1);
	...
	try
	{
		printDiscreteFunctionValues(func2D, -5.0, 5.0, 20, -5.0, 5.0, 10, "Gauss2", "H", "V", "L");
	}
	catch (DatasimException& e)
	{
			e.print();
