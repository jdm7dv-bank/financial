...
//	2008-1-10 DD for MC/C++ framework; end(), begin() now
//  
//
...
template <class V>
template <class V2> 
Set<pair<V, V2> > Set<V>::operator * (const Set<V2>& s2)
...
template <class V>
template <class V2> 
Set<pair<V, V2> > Set<V>::CartesianProduct(const Set<V2>& s2)
{
...
template <class V>
void Set<V>::InsertElement(const V& v)
{ // Insert an element
