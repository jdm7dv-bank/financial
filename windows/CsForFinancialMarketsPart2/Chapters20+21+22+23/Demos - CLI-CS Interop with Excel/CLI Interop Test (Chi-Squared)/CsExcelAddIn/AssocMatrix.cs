...
internal struct SpreadSheetVertex<AI1, AI2>
{
		public AI1 first;
		public AI2 second;
}

internal struct SpreadSheetRange<AI1, AI2>
{
...
internal delegate void FunctionEval<V>(ref V cellValue);

internal class AssocMatrix<AI1, AI2,V>
{
