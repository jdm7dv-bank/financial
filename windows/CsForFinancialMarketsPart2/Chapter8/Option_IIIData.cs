...
[DataContract (Name = "EuropeanOption")] public class OptionData
{
    ...
    [DataMember (Name = "Interest")] public double r;		// Interest rate
    [DataMember (Name = "Volatility")] public double sig;   // Volatility
    [DataMember (Name = "Strike")] public double K;		    // Strike price
    [DataMember (Name = "Expiry")] public double T;		    // Expiry date
    [DataMember (Name = "CostCarry")] public double b;		// Cost of carry

    [DataMember (Name = "OptionType")] public string otyp;   // Option name (call, put)
