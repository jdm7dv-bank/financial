...
public class BinomialMethodVII
{ // Simple model for GBM

        // Underlying data structure
    private Lattice<double> assetLattice;        	// Lattice structure for asset evolution
    private Lattice<double> optionLattice;        	// Lattice structure for option evolution
        ...
        public BinomialMethodVII (double discounting, BinomialLatticeStrategy strategy, int N) 
        {
